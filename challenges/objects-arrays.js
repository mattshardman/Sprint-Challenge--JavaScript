...
const universities = graduates
  ...
  .sort((a,b) => a.toLowerCase().charCodeAt() - b.toLowerCase().charCodeAt(0));
...
*/
const animalNames = [];
zooAnimals.forEach(animal => animalNames.push(`Name: ${animal.animal_name}, ${animal.scientific_name}.`));
